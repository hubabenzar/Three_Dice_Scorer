...
/*
The same for loop method is used here to calculate all the possible rolls.
As this dice has two 6 sides, I simply recreated the looping method above, 
but this time I made dice1 6 forcing it to loop all the numbers that it made before.
Then added it to the total again.
*/		
		int dice1 = 6;
		for(int dice2 = 1; dice2 <= 6; dice2++){
			for(int dice3 = 1; dice3 <= 6; dice3++){
...
*/
	System.out.printf("The average for all possible dice rolls is: " + "%.15f", ((float)total / (6*6*6)));
	}
}